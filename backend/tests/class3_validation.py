...
def run_test_case(case_id, heirs, expected, estate=120000):
    ...
    try:
        ...
        for r in result['results']:
            if not r.is_blocked:
                # Key by exact relation name as returned by engine
                key = r.relation
...
if __name__ == "__main__":
    ...
    cases = [
        ...
        # Case 3: Uncle + Aunt + Maternal Cousin (blocked)
        ...
        # Case 5: Substitution - Son of Aunt + Daughter of Uncle (Manual A5)
        # Inherits side-shares 2:1 per hardcode
